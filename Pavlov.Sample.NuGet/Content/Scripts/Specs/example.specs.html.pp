...
<head>
  ...
  <!--<script type="text/javascript" src="your-src.js"></script>  -->
  <!--<script type="text/javascript" src="your-specs.js"></script>  -->
  <script type="text/javascript" src="example.specs.js"></script>  
  <!-- <link href="your-css.css" rel="stylesheet" type="text/css" media="screen"/> -->
